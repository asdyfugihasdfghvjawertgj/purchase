...
$ordercontrol->updateOrder($orderid,$item,$qty,$name,$voucher_id,$date);
                   ...
                   <div class="row my-2 ml-3">
                       <div class="col-md-12">
                           <div class='float-right' style="background-color: green;">
                               <a href='itemindex.php' class='btn btn-primary pull-right'>View All</a>
                           </div>
                       </div>
                       <div class="col-md-12 my-2 " >
                         ...
                         <form method="POST">
                           <div class="form-group pt-3">
                               <label style="font-size: 20px; color: black;">Product Name</label>
                               <select style="width: 100%;" id="category" name="cat">
                           ...
                           <div class="form-group pt-3">
                               ...
                               <select style="width: 100%;" id="item" name="item">
                                   <option selected="selected">...Please Select Item</option>
                        <?php
                        ...
                        ?>     
                           ...
                           <div class="form-group pt-3">
                               <label style="font-size: 20px; color: black;">Item Quantity</label><br>
                               <input type="text" name="qty" id="input1" style="width: 100%;">
                           </div>

       
                           <div class="form-group">
                               <label style="font-size: 20px; color: black;">Username</label>
                               <select style="width: 100%;" id="item" name="name">
                        ...
                        ?>
                        <option value="<?php echo $cresult['id'];?>"><?php echo $cresult['firstname'];?> &nbsp;<?php echo $cresult['lastname'];?> </option>
                        <?php
                        }
                        ?>     
                               </select>
...
<script type="text/javascript">
    $("#category").change(function()
    {
      $cid=$(this).val();
      $("#item").empty();
        $.get("getitem.php",{cid:$cid},function(data){
        $("#item").html(data);
